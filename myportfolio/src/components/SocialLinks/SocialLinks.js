...
import styled from "../SocialLinks/SocialLinks.module.css";

const SocialLinks = () => {
  return (
    <div className="social-links">
      <a href="https://linkedin.com/in/jenniferm7" target="_blank" rel="noopener noreferrer">
        <i className="fab fa-linkedin">
          <svg className={styled.icon_linkedin} viewBox="0 0 32 32">
      ...
      <a href="https://github.com/itsjenm" target="_blank" rel="noopener noreferrer">
        <i className="fab fa-github">
          <svg className={styled.icon_github} viewBox="0 0 32 32">
      ...
      <a href="https://twitter.com/jendoescode" target="_blank" rel="noopener noreferrer">
        <i className="fab fa-twitter">
          <svg className={styled.icon_twitter}>
